...
class SendMoneyDialog extends StatefulWidget {
  ...
  const SendMoneyDialog({ Key? key, this.name, required this.phoneNumber, this.countryCode,
...
class _SendMoneyDialogState extends State<SendMoneyDialog> with SingleTickerProviderStateMixin {
        ...
        child: SizedBox(
          ...
          child: ScaleTransition(
            ...
            child: Dialog(
              ...
              child: ClipPath(
                clipper: TicketClipper(holeRadius: 40, bottom: 431),
                child: Card(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Center(child: Text(AppLocalizations.of(context)!.translate('sending_money'), style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.grey[600]), textScaleFactor: 1.0)),
                              ...
                              const SizedBox(height: 20),
                              Text(AppLocalizations.of(context)!.translate('sending_money_to'), style: TextStyle(color: Colors.grey[500], fontSize: 13)),
