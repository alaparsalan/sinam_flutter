...
class _LoginState extends State<Login> {
  ...
  void initState() {
    super.initState();
    selectedCountryCode = AppConfig.countryCode;
    print('country code: ${AppConfig.isoCountryCode}');
  }
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(AppLocalizations.of(context)!.translate('phone_number'), style: TextStyle(fontSize: 13, color: Colors.grey[700])),
                  ),
                  AppTextField(
                    isEnable: submitSt,
                    borderRadius: 10,
                    ...
                    suffixIcon: Container(
                      width: 40, height: 40,
                      child: const Icon(Icons.phone_iphone_rounded, color: Colors.white, size: 23),
