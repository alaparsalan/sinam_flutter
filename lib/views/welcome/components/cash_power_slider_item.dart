...
class CashPowerSliderItem extends StatelessWidget {
  const CashPowerSliderItem({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Center(child: Image.asset('assets/images/cash_power.png', width: AppConfig.screenWidth - ScreenUtil().setWidth(120))),
        const SizedBox(height: 12),
        SizedBox(
          width: MediaQuery.of(context).size.width - ScreenUtil().setWidth(160),
          child: Text(AppLocalizations.of(context)!.translate('cash_power_description'), style: TextStyle(overflow: TextOverflow.ellipsis, color: Colors.grey[700]!), textAlign: TextAlign.center, maxLines: 3)),
        ...
        GradiantButton(
            ...
            onPressed: () async{
              ...
              openURL(AppConfig.cashPowerURL, context);
            }
        ),
      ],
    );
